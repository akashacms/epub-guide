...
To get the most out of this section it's best to be reading the `config.js` for this book at [github.com/akashacms/epub-guide/blob/master/config.js](https://github.com/akashacms/epub-guide/blob/master/config.js).
